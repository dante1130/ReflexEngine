...
Scene.add_game_object("game/TheDen/prefabs/lights/middle_lights/middle_light3.lua")
Scene.add_game_object("game/TheDen/prefabs/lights/left_lights/left_light1.lua")
...
--Ribux cubes
Scene.add_game_object("game/TheDen/prefabs/small_objects/rubix_cubes/rubix_cube_one.lua")
--tissue boxes
