...
function init(ecs, entity)
	...
	rb:add_box_collider(Math.vec3.new(0.262, -0.13, -0.29), Math.vec3.new(9, 0, 0), Math.vec3.new(0.02, 0.45, 0.02), 0.5, 3, 0.25)
	rb:add_box_collider(Math.vec3.new(-0.262, -0.13, -0.29), Math.vec3.new(9, 0, 0), Math.vec3.new(0.02, 0.45, 0.02), 0.5, 3, 0.25)
	rb:add_box_collider(Math.vec3.new(0.262, -0.12, 0.23), Math.vec3.new(-15, 0, 0), Math.vec3.new(0.02, 0.45, 0.02), 0.5, 3, 0.25)
	rb:add_box_collider(Math.vec3.new(-0.262, -0.12, 0.23), Math.vec3.new(-15, 0, 0), Math.vec3.new(0.02, 0.45, 0.02), 0.5, 3, 0.25)
