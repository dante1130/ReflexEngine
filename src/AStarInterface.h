...
class AStar
{
	public:
		...
		* 
		* @param	newGrid	- The grid to store information from (0 = free space, everything else it is not allowed to move into)
		*
		...
		*
		* @param	allow	- true: allow diagonal movement, false: don't allow diagonal movement
		*
		* @return	bool	- If it was successful
		*/
