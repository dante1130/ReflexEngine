...
public:
	 ...
	 */
	static void init(GLFWwindow* window, const std::string& openglVersion);
	 ...
	 */
	static void setWindowPos(int xPos, int yPos, int constraint);
	 ...
	 */
	static void setWindowSize(int xSize, int ySize, int constraint);
	 ...
	 * @post	module added
	 */
	static void checkbox(const std::string& name, bool* option);
	 ...
	 * @post	module added
	 */
	static bool luaCheckBox(const std::string& name, bool state);
	 ...
	 * @post	module added
	 */
	static void sliderFloat(const std::string& name, float* value, float min,
	                        float max);
	 ...
	 * @post	module added
	 */
	static void sliderInt(const std::string& name, int* value, int min,
	                      int max);
	 ...
	 * @post	module added
	 */
	static void sliderAngle(const std::string& name, float* angle, float min,
	                        float max);
	 ...
	 * @post	module added
	 */
	static void colourEdit3(const std::string& name, float colour[3]);
	 ...
	 * @post	module added
	 */
	static void colourEdit4(const std::string& name, float colour[4]);
	 ...
	 * @param texture_name
	 */
	static void lua_image(const std::string& texture_name);
	 ...
	 * @param height
	 */
	static void image(uint32_t texture_id, int width, int height);
	 ...
	 * @post	module added
	 */
	static bool button(const std::string& name, int xSize, int ySize);
	 ...
	 * @post	module added
	 */
	static std::string luaInputText(const std::string& name);
	 ...
	 * @post	module added
	 */
	static bool inputText(const std::string& name, char* buffer, int size);
	 ...
	 * @post	module added
	 */
	static void plotLines(const std::string& name, const float* values,
	                      int numOfEntries);
