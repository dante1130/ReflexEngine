...
namespace aStar
{
	...
	*
	* @param	grid				- The grid of the area you are trying to move through
	* @param	movementCost		- [0] - horizontal movement cost [1] - diagonal movement cost [2] - allow diagonal movement
	...
	* @return	The shortest estimated difference from the current position and goal
	*/
	float DiagonalHeuristic(const float movementCostManhattan, const float movementCostDiagonal, node pos, const node goal);
