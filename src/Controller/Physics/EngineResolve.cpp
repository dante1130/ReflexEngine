...
void EngineResolve::initialise_body(glm::vec3 pos, glm::vec3 rot, float angle) {
	...
	cb = Physics::getPhysicsWorld()->createCollisionBody(
...
void EngineResolve::addTorque(glm::vec3 torque, Apply type) { return; }

void EngineResolve::addDragForce(float drag) { lin_drag += drag; }

void EngineResolve::addDragTorque(float ang_drag) { return; }

void EngineResolve::setMass(float mass) { mass_ = mass; }

void EngineResolve::setCenterOfMass(glm::vec3 p) { return; }

void EngineResolve::setVelocity(glm::vec3 vel) { lin_velocity_ = vel; }
void EngineResolve::setAngVelocity(glm::vec3 ang_vel) { return; }
void EngineResolve::setDragForce(float drag) { lin_drag = drag; }

void EngineResolve::setDragTorque(float ang_drag) { return; }

void EngineResolve::setType(BodyType type) { type_ = type; }
...
void EngineResolve::enableGravity(bool ean) { use_gravity_ = ean; }

void EngineResolve::setCanSleep(bool ean) { can_sleep_ = ean; }

float EngineResolve::getMass() { return mass_; }
glm::vec3 EngineResolve::getVelocity() { return lin_velocity_; }
glm::vec3 EngineResolve::getAngVelocity() { return glm::vec3(0.0f); }
float EngineResolve::getDragForce() { return 0.0f; }
float EngineResolve::getDragTorque() { return 0.0f; }

BodyType EngineResolve::getType() { return type_; }
